...
<details markdown="1">
  <summary>🔎 Ver salida completa de Nmap (click para expandir)</summary>
...
| **192.168.56.20** | DC-AC    | DNS (53), Kerberos (88), RPC (135), NetBIOS (139), LDAP/LDAPS (389/636/3268/3269), SMB (445), Kpasswd5 (464), RPC/HTTP (593), RDP (3389), WinRM HTTP/HTTPS (5985/5986), .NET Message Framing (9389) |
...
Además se puede ver que hay un apartado para búsqueda de estudiantes, que hace por cada consulta una petición GET http://192.168.56.21/Students?SearchString=asd&orderBy=Firstname
